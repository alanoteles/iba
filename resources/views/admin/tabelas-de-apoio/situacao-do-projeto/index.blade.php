...
@section('title','Situação de Projeto')
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 align-right margin-top-10">
            <a href="" data-route="/admin/tabelas-de-apoio/situacao-do-projeto/create">
            ...
            <table id="sample-table-1" class="table table-striped table-bordered table-hover no-margin">
                ...
                <tr>
                    ...
                    <td class="nome-grupo" style="width: 70%;">
                        <a href="" data-route="/admin/tabelas-de-apoio/situacao-do-projeto/{{$resultado->project_situation_id}}/edit">
                            {{ $res['name'] }}
                        </a>
                    </td>
                    <td class="hidden-480 situacao situacao-clientes">
                        <select class="form-control transparent status" name="status" data-id="{{$resultado->project_situation_id}}">
                    ...
                    <td class="acoes center">
                        <div class="btn-group">
                            <a href="#" class="btn btn-xs btn-grey remover-item-lista excluir" data-id="{{$resultado->project_situation_id}}">

...
@section('title','Modalidade de Projeto')
...
@section('content')
    ...
    <div class="row">
        <div class="col-xs-12 align-right margin-top-10">
            <a href="" data-route="/admin/tabelas-de-apoio/modalidade-de-projeto/create"><button class="btn btn-sm btn-success">Nova modalidade</button></a>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table id="sample-table-1" class="table table-striped table-bordered table-hover no-margin">
                ...
                <tr>
                    ...
                    <th style="width: 70%;">Modalidade</th>
                ...
                <tr>
                    ...
                    <td class="nome-grupo" style="width: 70%;"><a href="" data-route="/admin/tabelas-de-apoio/modalidade-de-projeto/{{$resultado->id}}/edit">{{$resultado->name}}</a></td>
